...
echo "开始执行编译脚本"
apt-get update
apt-get install -y build-essential wget libargon2-dev libmaxminddb-dev libpsl-dev libpsl-dev libldap2-dev libpq-dev libsqlite3-dev libpcre2-dev libre2-dev libgnutls28-dev libssl-dev rapidjson-dev pkg-config
