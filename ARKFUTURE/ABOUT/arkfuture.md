...
# 第四章 管理运维/运营 人员
* 成为管理人员需要您提交一个自己的pgp(gpg)公钥 到 ARKFUTURE 的密钥环; 不限制邮箱.
* 用户名及昵称: 用户的名称(并非真名) 及 代号(昵称必须是聊天软件常用的名称)
* 遵循中立的管理规则
* * 
* 至2025年03月01日 管理运维/运营 成员名单 及公钥 :
```
用户名及昵称 | 简介及职业 | Openpgp Key ID
1.Wteani(arkfuture) | ARKFUTURE创建人 | 
2.

```
* 至2025年03月01日 管理运维/运营 已经废弃公钥声明 (此项指已经删除(废弃)私钥而没有同步到公钥服务器缓存的公钥ID) :
```
服务器:keyserver.ubuntu.com;keys.openpgp.org
1.0xb74109c5686539ca68a781a9ed51a1876c121152
2.0x16fc242df0eeeef6fe6154559277a35f89ed2492
