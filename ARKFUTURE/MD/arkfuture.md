...
* 若普通成员有意加入管理运维工作组, 必须向管理运维工作组中 [我们所写的聊天平台 昵称为arkfuture的管理运维工作组成员]申请, 并通过初始管理运维工作组的投票及审核. 
...
* 同时我们也引入网络拓扑(Network Topology)的对等概念---我们称之为成员节点拓扑(Member node Topology)概念, 用于描述成员节点之间的关系方式. 网络拓扑中所描述的节点间关系, 在成员节点拓扑中同样适用.
