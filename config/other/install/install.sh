...
if [ "$version" == "1" ]; then
    ...
    curl -L -o inspircd.deb https://github.com/inspircd/inspircd/releases/download/v4.9.0/inspircd_4.9.0.deb13u1_amd64.deb
    ...
    curl -L -o inspircd.deb https://github.com/ARKFUTURE/ARKFUTURE.github.io/releases/download/20250310/inspircd_deb13u1_amd64.deb
    echo "校验,请对比官网所给出的sha256sum"
    sha256sum inspircd.deb
    sha512sum inspircd.deb
    echo "下载完成,等待自动安装"
